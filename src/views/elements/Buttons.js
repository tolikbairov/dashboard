            ...
            <Card>
              ...
              <CardBody>
                ...
                <Button color="secondary">
                  <i className="fa fa-arrow-left"></i>&nbsp;&nbsp;Left
                </Button>{' '}
                <Button color="secondary">
                  Right&nbsp;&nbsp;<i className="fa fa-arrow-right"></i>
                </Button>{' '}
              </CardBody>
            </Card>
          </Col>
            ...
            <Card>
              ...
              <CardBody>
                ...
                <Button color="primary" block>
                  <i className="fa fa-cloud-download"></i>&nbsp;&nbsp;Block Level Button
                </Button>{' '}
                <Button color="secondary" block>
                  <i className="fa fa-cloud-download"></i>&nbsp;&nbsp;Block Level Button
                </Button>{' '}
            ...
            <Card>
              ...
              <CardBody>
                ...
                <Button color="primary" block outline>
                  <i className="fa fa-cloud-download"></i>&nbsp;&nbsp;Outline Button
                </Button>{' '}
                <Button color="secondary" block outline>
                  <i className="fa fa-cloud-download"></i>&nbsp;&nbsp;Outline Button
                </Button>{' '}
          ...
          <Col xs="12" md="6">
            <Card>
              ...
              <CardBody>
                ...
                <p>
                  <Button color="primary">Default Button</Button> <Button color="secondary">Default Button</Button>
                </p>
                <p>
