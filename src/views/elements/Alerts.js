        ...
        <Row>
          <Col md={6}>
            <Card>
              ...
              <CardBody>
                <UncontrolledAlert color="info">Wow! This alert is amazing!</UncontrolledAlert>
                <UncontrolledAlert color="primary">Welcome! Glad to have you here!</UncontrolledAlert>
                ...
                <UncontrolledAlert color="default">Welcome! Glad to have you here!</UncontrolledAlert>
              </CardBody>
            </Card>
          </Col>
          <Col md={6}>
                  ...
                  {context => (
                    <div>
                      <Form>
                        ...
                        <Button onClick={() => context.setAlert(this.state.alertMessage, this.state.alertType)}>
                          Create Page Alert
                        </Button>
                      </Form>
                    </div>
